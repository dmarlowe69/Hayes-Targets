 ...
 ***************************************************************************/
	...
	if(toupper(c) == 'P') {
//		print_scr(0, 0, (vc.numxpixels-1), (vc.numypixels-1), 0, 0, SINGLE);
		print_scr(0, 0, (vc.numxpixels-1), (vc.numypixels-1), 0, 0, DOUBLE);
//		print_scr(0, 0, (vc.numxpixels-1), (vc.numypixels-1), 0, 0, QUAD);
		fprintf(stdprn,"\f");
		reset();
		}
